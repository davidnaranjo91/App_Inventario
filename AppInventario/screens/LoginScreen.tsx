...
const API_URL = "http://localhost:3000/api" // Cambia por tu IP local para dispositivo físico
...
export default function LoginScreen({ navigation, onLogin }) {
  ...
  return (
    <View className="flex-1 justify-center px-6 bg-white">
      ...
      <TouchableOpacity className="py-2" onPress={() => navigation.navigate("Register")}>
